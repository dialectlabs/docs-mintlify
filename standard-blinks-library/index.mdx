...
<CardGroup cols={2}>
  <Card
    title="Jupiter"
    icon="https://res.cloudinary.com/dnxjhra4h/image/upload/v1763721553/jupiter-icon_lhjgb3.png"
  ...
  <Card title="Kamino" icon="kamino" href="/standard-blinks-library/kamino">
