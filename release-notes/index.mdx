...
- **Jupiter Lend Earn Integration** - Added Jupiter Earn lending protocol with support for deposit and withdrawal actions

## Markets API Updates

Enhanced API responses with richer metadata for improved developer experience:
...
We've made significant performance optimizations by optimizing our indexing process, delivering faster data access across all supported protocols.
