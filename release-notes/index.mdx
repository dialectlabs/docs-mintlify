...
We've added a new tutorial, explaining how to collect feedback from users using a blink. Data is stored off-chain and we use message signing to ensure it's gas-free. This tutorial is available in the [guides section](/blinks/blinks-provider/guides).
