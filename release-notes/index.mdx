...
Enhanced documentation with new [Market Types](/markets/market-types/introduction) coverage, explaining how different DeFi strategies work and how to use our APIs to integrate them. Each market type includes detailed guides with data structures, supported protocols, and integration examples:
