...
- **New PnL Endpoint** - New [`GET /v0/positions/pnl`](/api-reference/positions/pnl) endpoint returns realized and unrealized PnL for prediction market positions, including closed positions. [Learn more](/markets/market-types/prediction)
...
- **DeFiCarrot Integration** - Added DeFiCarrot blinks allowing users to mint and redeem CRT tokens right from the protocol [View API docs](/api-reference/mint/get-mint-blink)
