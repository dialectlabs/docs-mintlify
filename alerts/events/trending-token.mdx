...
<Tip>
Trending Token Events are currently in beta. Contact us for [early access](https://form.typeform.com/to/WlSWtZDY) or to discuss specific requirements.
</Tip>
...
- **launchpad**: Name of the launchpad platform (e.g., "Raydium Launchpad")
