...
- [Price Change](/alerts/events/price-change), 
- [Trending Token](/alerts/events/trending-token), and 
- [Last Trade Price Change](/alerts/events/price-change#trade-based-price-changes-last-trade)