...
[Contact Dialect](https://form.typeform.com/to/uIBkRDsF?utm_source=docs&utm_medium=typeform&utm_campaign=webhook-registration&utm_content=using-events-webhook-setup) to register your webhook endpoint and configure event types:
