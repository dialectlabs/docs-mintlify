...
We're developing event detection for newly launched tokens that meet specific criteria. This system focuses on tokens with "staying power" rather than short-lived movements.

### Detection Approach

The system monitors tokens from bonding curve protocols and applies multiple filters:

**Market Cap Thresholds**
- Configurable thresholds at sub-graduation, graduation, or post-graduation levels
- Focus on 2-3 quality events per day based on market cap criteria

**Audit Criteria**
- **Mint authority** - Whether mint authority has been revoked 
- **Freeze authority** - Whether freeze authority has been revoked
- **LP burned** - Whether liquidity provider tokens have been burned
- **Top 10 holders** - Analysis of holder distribution concentration
- **Social presence** - At least one social media presence
...
Trending token events are in beta development. The system is being tested internally with smart defaults before expanding to user customization.
