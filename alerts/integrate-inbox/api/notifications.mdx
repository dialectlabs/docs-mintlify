...
The response includes everything needed to build UIs ranging from simple notification buttons to detailed position management screens. Use the data to create position context cards, input interfaces, action buttons, and more.
