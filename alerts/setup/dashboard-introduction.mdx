...
1. **[Send your first alert](/alerts/send)** - Learn to send notifications programmatically
2. **[Integrate an inbox](/alerts/integrate-inbox/index)** - Add notification UI to your app