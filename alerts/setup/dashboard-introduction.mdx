 ...
 **Want to learn more about sending notifications using the dashboard?** Check out our [detailed guide in the send section](../send/dashboard).
...
> 📖 **Note**: While the dashboard guide is available, we recommend using our [quickstart guide](../quick-start) from the docs for the most up-to-date setup instructions.
...
2. **[Integrate an inbox](../integrate-inbox/index)** - Add notification UI to your app