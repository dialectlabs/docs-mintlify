...
**Options:**
- **[Dialect Monitor](/alerts/alerts-and-monitoring/setup-event-detection)**: Our open-source monitoring tooling for new integrations or those who want to switch
- **[Custom Event Detection](/alerts/alerts-and-monitoring/integrate-existing-system)**: Integrate with your existing event systems
...
📚 **[Learn more about topics, channels, and subscribers →](/alerts/setup/topics-channels-subscribers)**
