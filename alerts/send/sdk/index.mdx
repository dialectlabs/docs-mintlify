...
### Backend Services
- **Event-driven notifications**: Send alerts when specific events occur in your application (also have a look into our [Monitoring SDK](../../alerts-and-monitoring/index) for advanced use-cases)
