...
**Setting up user subscriptions:** See our **[User Management guide](../../integrate-inbox/user-management)** for implementation details.
</Warning>
...
1. **Authentication Setup**: Have your API key ready (see the [Authentication guide](./authentication) if you need to set this up)
2. **App Registration**: Your app must be [registered](../../setup/register-app) with Dialect  
3. **User Subscriptions**: Ensure your users have [subscribed](../../integrate-inbox/user-management) to receive notifications from your app
