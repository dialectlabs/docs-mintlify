...
curl https://alerts-api.dial.to/v2/{appId}/send \
  ...
  --data '{
    ...
    "message": {
      ...
      "body": "Your WSOL/USDC position is at 78% LTV, approaching liquidation threshold of 80%.",
      "actions": [{
        "type": "link",
...
When a supported URL is detected, the client receives the enriched alert with the `context` object:
