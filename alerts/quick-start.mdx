...
Want to customize the look and feel of your notification bell? Check out our **[Event Detection and Monitoring](./alerts-and-monitoring/index)** guide where you can see how companies like Tensor have customized the notification widget to match their brand.
...
- **[Sending Guide](./send/index)** - Send alerts to your users either programmatic or by using or no-code Dashboard
- **[Universal Inbox Guide](./integrate-inbox/index)** - Integrate an Inbox using APIs or advanced UI components
- **[Event Detection and Monitoring](./alerts-and-monitoring/index)**: Use events to send notifications to your users
