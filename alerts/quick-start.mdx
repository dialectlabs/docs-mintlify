...
<video src="https://res.cloudinary.com/dnxjhra4h/video/upload/v1755637716/subscribe-to-notifications-topics-and-channels_tviyki.mp4" controls />
...
Go back to your app or our [Alerts Example App](https://alerts-example.dialect.to) and:
...
- **[API Guide](/api-reference/send-alerts/send-alert)** - Get an overview of available API endpoints
