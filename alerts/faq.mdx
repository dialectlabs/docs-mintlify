...
description: "Common questions and answers about Dialect's Alert Stack."
---
...
1. **[Register your app](/alerts/setup/register-app)** - Get API credentials
2. **[Create topics](/alerts/setup/topics-channels-subscribers)** - Define notification types
3. **[Send notifications](/alerts/send)** - Integrate sending in your app
4. **[Add subscription UI](/alerts/integrate-inbox/)** - Let users manage preferences

The [Quick Start guide](/alerts/quick-start) walks through this in ~15 minutes.
