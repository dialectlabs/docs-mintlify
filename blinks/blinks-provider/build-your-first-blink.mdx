...
This guide will focus on the `BlinkProvider`. If you want to learn about integrating our blink SDK for your front end, please visit our [blink client section](../blinks-client/integrate).
...
If you want more hands-on examples, visit our [guides section](./guides/index.mdx).