...
<img
  src="https://res.cloudinary.com/dnxjhra4h/image/upload/f_auto,q_auto/dialect-docs/donate-sol-dialto-ex.png"
  alt="Blink rendered on dial.to"
/>
...
Please note that it is strongly advised to [register your blink](/blinks/blinks-provider/blink-registry). Registered blinks will unfurl on social media sites, such as X.
