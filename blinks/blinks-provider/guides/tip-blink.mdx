...
<img
  src="https://res.cloudinary.com/dnxjhra4h/image/upload/f_auto,q_auto/dialect-docs/nextjs-public-folder.png"
  alt="Screenshot of public folder in NextJS project"
/>
...
<Warning>
  Note: [dial.to](http://dial.to/) currently supports only `GET` previews for
  `EVM`. To test your `POST` endpoint, please follow the tutorial to the end,
  where we implement the blink client in the frontend.
</Warning>
...
<img
  src="https://res.cloudinary.com/dnxjhra4h/image/upload/f_auto,q_auto/dialect-docs/monad-blink-dialto-test.png"
  alt="Screenshot of a blink rendered on dial.to"
/>
