...
| `positionIds` | No | Optional array of position IDs to filter. If empty, returns all positions (limited to 1000 data points) |
...
| `history` | Array of historical snapshots with `timestamp`, `amount`, and `amountUsd` |
