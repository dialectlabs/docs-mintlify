...
Yield markets are often misinterpreted as lending markets, but they work differently. Below is a comparison of the two:

| Feature               | Yield Markets                        | Lending Markets                                          |
| --------------------- | ------------------------------------ | -------------------------------------------------------- |
| **Primary Action**    | Deposit to earn                      | Deposit to lend, with borrowing option                   |
| **Return Source**     | Trading fees, strategies, LP rewards | Borrower interest payments + protocol rewards (optional) |
