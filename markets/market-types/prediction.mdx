...
We are currently not supporting Blinks to make bets in a prediction market. If you want to request this feature, please reach out to us via our [contact form](https://form.typeform.com/to/zHHLsFUV).

If you still want to support actions, pls checkout [DFlow's documentation](https://pond.dflow.net/build/prediction-markets/).
