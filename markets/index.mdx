...
<img
  src="https://res.cloudinary.com/dnxjhra4h/image/upload/f_auto,q_auto/v1750948122/dialect-docs/makets-landing.png"
  alt="Markets Beta - Real-time market data dashboard"
/>{" "}
...
<CardGroup cols={2}>
  <Card
    ...
    icon="clock"
  >
    Our market data is updated every 10 minutes.
  </Card>

{" "}

<Card title="Multi-Protocol Support" icon="building-columns">
  Unified data format across Solana's top DeFi protocols.
</Card>

{" "}

<Card title="Blinks Integration" icon="bolt">
...
<CardGroup cols={2}>
  <Card title="Quickstart" icon="bolt" href="/markets/quick-start">
    Learn how to use and transform market data into instant DeFi actions
  </Card>
  <Card
    title="Try the API"
    icon="arrow-right"
